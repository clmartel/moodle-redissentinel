...
$settings->add(
    new admin_setting_configtext(
        'cachestore_redissentinel/test_sentinel_server',
        get_string('test_sentinel_server', 'cachestore_redissentinel'),
        get_string('test_sentinel_server_desc', 'cachestore_redissentinel'),
        '',
        PARAM_TEXT,
        16
    )
...
$settings->add(
    new admin_setting_configtext(
        'cachestore_redissentinel/test_master_set_name',
        get_string('test_master_set_name', 'cachestore_redissentinel'),
        get_string('test_master_set_name_desc', 'cachestore_redissentinel'),
        '',
        PARAM_TEXT,
        16
    )
