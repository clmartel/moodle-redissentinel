 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cachestore_redissentinel_test extends cachestore_tests {
    /**
    ...
    public function setUp() {
        if (!cachestore_redissentinel::are_requirements_met() || !defined('TEST_CACHESTORE_REDISSENTINAL_TESTSERVERS')) {
     ...
     * @return cachestore_redissentinel
     */
    protected function create_cachestore_redissentinel() {
        ...
        $store = new cachestore_redissentinel('Test', cachestore_redissentinel::unit_test_configuration());
